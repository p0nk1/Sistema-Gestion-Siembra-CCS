...
$rs=query_buscar_datos_usuario($id_usuario);
...
if (isset($guardar_registro))
{
  ...
  editar_usuario(dar_formato($id_usuario), dar_formato($nombres_usuario), dar_formato($email), dar_formato($login),
                 dar_formato($telefono_1), dar_formato($telefono_2), dar_formato($fecha_registro),
                 dar_formato($id_usuario_registra), dar_formato($ip_maquina_registra), dar_formato($id_perfil));
  $exito_registro = 1;
  if ($exito_registro == 1)
  {
    echo "<script type='text/javascript' languaje='javascript'>alert('El Usuario Fue actualizado con Exito !!!'); location.href = 'consultar_usuario.php'; </script>";
  }
...
$v3 = new MCI_validacion("editar_usuario");
...
<html>
    ...
    <body>
        <!-- INICIO CUERPO-->
        <FORM method="POST" name="editar_usuario" action="" enctype="multipart/form-data">
            <BR>
            <TABLE border="0" width="70%" cellpadding="0" cellspacing="0" align="center">
                <TR>
                    <TD class="tituloForm">EDITAR USUARIO</TD>
                </TR>
                <TR><TD><HR></TD></TR>
            </TABLE>
            <TABLE border="0" width="70%" cellpadding="2" cellspacing="2" align="center">
                <TR>
                    <TD class="alerta2" height="40">
                        <?php echo $v3->html_error("editar_usuario"); ?><?php echo $v3->campo_oculto(); ?>
...
<!--                        <input id="por_donde_buscar" name="por_donde_buscar" type="hidden" value='1'>-->
                        <input  onkeypress='return(formato_campo(this,event,1))' value="<?php echo $rs['cedula']?>" disabled onpaste='return(formato_campo(this,event,1))' style='text-transform:uppercase;' maxlength="12" name="cedula"  type="text" size="30">
                    </TD>
                </TR>
                <TR>
...
<!--                        <input id="oculto_id_nombre" name="oculto_id_nombre" type="hidden">-->
                        <input onkeypress='return(formato_campo(this,event,2))' onpaste='return(formato_campo(this,event,2))' value="<?php echo $rs['nombre_usuario']?>" name="nombres_usuario" maxlength="51" type="text" size="30" onkeyup="this.value = this.value.toUpperCase();">
                    </TD>
                </TR>
...
<!--	<input name="p_nombre" id="p_nombre_a" type="hidden" value="<? //=$p_nombre   ?>">
        ...
        <INPUT type="hidden" name="fecha_nacimiento" id="fecha_nacimiento" value="<? //=$fecha_nacimiento   ?>">-->
                ...
                <TR>
                    ...
                    <TD class="texto_campo" bgcolor="White">
                        <input onkeypress='return(formato_campo(this,event,1))' value="<?php echo $rs['telefono_1']?>" onpaste='return(formato_campo(this,event,1))' name="telefono_1" type="text" maxlength="12" size="30">
                    </TD>
                </tr>
                <tr>
                    <TD class="tituloTablas" width="20%" bgcolor="White">&nbsp;Tel&eacute;fono 2:</TD>
                    <TD class="texto_campo" bgcolor="White">
                        <input onkeypress='return(formato_campo(this,event,1))' value="<?php echo $rs['telefono_2']?>" onpaste='return(formato_campo(this,event,1))' name="telefono_2" type="text" maxlength="12" size="30">
                    </TD>
                </TR>
                <!-- ******************************************* VALIDA EMAIL COINCIDAN  ************************************************-->
                <TR class="textoCampo">
                    <TD bgcolor="White" class="tituloTablas">&nbsp;Ingresar E-mail:<a class="campo_obligatorio" >&nbsp;*</a></TD>
                    <TD bgcolor="White"><input name="email" value="<?php echo $rs['correo_electronico']?>" type="text" size="30"></TD>
                </TR>
                <TR class="textoCampo">
                    <TD bgcolor="White"><span class="tituloTablas">&nbsp;Confirmar E-mail:<a class="campo_obligatorio" >&nbsp;*</a></span></TD>
                    <TD bgcolor="White"><input name="email_confirm" value="<?php echo $rs['correo_electronico']?>" type="text" size="30"></TD>
                </TR>
                <!-- ******************************************* FIN VALIDA EMAIL COINCIDAN  ************************************************-->
                <!-- ******************************************* login y password  ************************************************-->
                <TD bgcolor="White" class="tituloTablas">&nbsp;Login:<a class="campo_obligatorio" >&nbsp;*</a></TD>
                <TD bgcolor="White"><input name="login" value="<?php echo $rs['login']?>" type="text" size="30" maxlength="15"></TD>
                </TR>                              
		 <TR class="textoCampo">
