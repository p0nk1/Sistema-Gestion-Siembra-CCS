    ...
    <body>
        <TABLE border="0" width="80%" cellpadding="0" cellspacing="0" align="center">
            ...
            <form id="search_form" action="" accept-charset="utf-8" method="post">
				...
				if ($row['id_perfil']!=""){
				$perfil = traerNombrePerfil($row['id_perfil']);
				}
                        ?>
                <tr class="gradeX">
                    ...
                    <td style="width:11%;" align="center" class="texto_campo"><?php echo $telefono_2; ?></td>
                    <td style="width:12%;" align="left" class="texto_campo"><?php echo $correo_electronico; ?></td>
                    <td style="width:10%;" align="left" class="texto_campo"><?php echo $perfil; ?></td>
