...
var simpleGallery_navpanel={
	loadinggif: '../imagenes/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'45px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ '../imagenes/left.gif', '../imagenes/play.gif', '../imagenes/right.gif', '../imagenes/pause.gif'], //nav panel images (in that order)
