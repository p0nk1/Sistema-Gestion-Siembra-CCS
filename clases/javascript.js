...
function porcentaje(valor)
{
	...
	var propuestos =  document.getElementById('propuestos').value;
	var porcentaje= 0;

	porcentaje= 100-((parseInt(propuestos)*100)/parseInt(mercado))
	
	document.getElementById('ahorro_bsf').value = porcentaje+'%';
}
...
onload = function(){
	...
	ayuda=new Array();
	ayuda["RIF"]="Ingrese RIF. ejemplo: v1234567. OBLIGATORIO";
	ayuda["Nombre Proveedor"]="Ingrese el nombre del Proveedor. De 4 a 50 caracteres. OBLIGATORIO";
	ayuda["Direccion"]="Ingrese Direccion de Domicilio del Proveedor.";
	ayuda["Telefonos Contacto"]="Ingrese tlf. Habitacion y tlf.Celular. OBLIGATORIO";
	ayuda["Detalle"]="Ingrese Detalles del Proveedor. Maximo 500 caracteres. OBLIGATORIO";
