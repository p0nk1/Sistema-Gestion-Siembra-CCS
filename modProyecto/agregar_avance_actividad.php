...
//print_r($_POST);
if($porcentaje_avance_actividad > $restante){

echo "<script>alert('El porcentaje del avance no debe ser mayor al porcentaje restante');</script>";
...
return false;
			...
			$result = registrarAvance(dar_formato($id_actividad),dar_formato($avance_actividad), dar_formato($dificultad_actividad), dar_formato($fecha_avance), dar_formato($porcentaje_avance_actividad), dar_formato($id_usuario_registra) , dar_formato(1));
			
			if (!empty($result) and !empty($volver))
			{
...
$v3 = new MCI_validacion("agregar_avance");
...
info.innerHTML ="<b>La Ponderación no debe ser mayor al Porcentaje Restante</b>";
...
<!--***************************************-->
	...
	<BODY>
<BR>
<FORM action="" id="agregar_avance" name="agregar_avance" method="POST" >
	<TABLE border="0" width="90%" cellpadding="0" cellspacing="0" align="center">
		<TR><TD class="tituloBackground"> AGREGAR AVANCE </TD></TR>
	</TABLE>
	<BR>
<div class="alerta2" style="text-align:center;"><?php echo $v3->html_error("agregar_avance"); ?><?php echo $v3->campo_oculto(); ?></div>
...
<td bgcolor="White" colspan="3" class="tituloTablas">
<span class="progressBar" id="pb1"><? if($porcentaje==""){ echo "0";}elseif ($porcentaje>100){ echo "100";}else{ echo $porcentaje;}?>% </span>
</td>
</tr>
<tr>
<td bgcolor="White" class="subtituloBackground">Avance:</td>
<td bgcolor="White" colspan="3" class="tituloTablas">
<textarea name="avance_actividad" id="avance_actividad" style="width: 260px; height: 50px"></textarea>
</td>
</tr>
<tr>
<td bgcolor="White" class="subtituloBackground">Dificultad:</td>
<td bgcolor="White" colspan="3" class="tituloTablas">
<textarea name="dificultad_actividad" id="dificultad_actividad" style="width: 260px; height: 50px"></textarea>
</td>
</tr>
<tr>
<td bgcolor="White" class="subtituloBackground">Fecha:</td>
<td bgcolor="White" colspan="3" class="tituloTablas">
<input size="10" id="f_date1" name="fecha_avance" readonly="true" value="" onblur="this.style.backgroundColor='#ffffff';this.style.backgroundImage=''"/>
                        <button id="f_btn1">...</button>
</td>
</tr>
<tr>
<td bgcolor="White" class="subtituloBackground">Ponderacion:</td>
<td bgcolor="White" colspan="3" class="tituloTablas"><input style='text-transform:uppercase;' value="" maxlength="3" name="porcentaje_avance_actividad" id="porcentaje_avance_actividad"  type="text" size="16" onfocus="if (this.value == '0') {this.value = '';}"  onblur="this.style.backgroundColor='#ffffff';this.style.backgroundImage='';if (this.value == '') {this.value = '0';};" onkeyup="validar(this,this.value.charAt(this.value.length-1))"><span style="font-weight: lighter;"> de <?php echo 100-$porcentaje; ?> % Restante</span>
<input type="hidden" name="restante" id="restante" value="<?php echo 100-$porcentaje; ?>">
</td>
</tr>
</table>
<BR>
           <TABLE id="tablaBoton" border="0" cellpadding="0" cellspacing="0" align="center" width="90%">
                    <TR>
                        <td bgcolor="White" align="right">
                          <INPUT id="registrar" name="registrar" type="submit" value="REGISTRAR" class="botonPeq" onclick="">
                        </td>
			<?php if ($volver!=""){
			...
			?>
                        <TD align="left"><input name="cerrar" value="Cerrar" style="width: 100px;" onclick="self.close();" class="botonPeq" type="button"></TD>
                    </TR>
                </TABLE>
</FORM>
