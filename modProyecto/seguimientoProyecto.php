...
//$datproyec=buscar_proyectos_seguimiento();
$id_usuario = $_SESSION['adminProy']['id_usuario'];
$perfil =$_SESSION['adminProy']['id_perfil'];
//esto lo quite por que ya no hay figura de analistas
/*if ($perfil == 3) {

$datproyec=buscar_proyectos_seguimiento_analista($id_usuario);
...
<HTML>
	...
	<BODY>
		...
		<TABLE id="tablaTitulo" border="0" cellpadding="0" cellspacing="0" align="center" width="90%">
			<TR><TD class="tituloBackground">  SEGUIMIENTO DE PROYECTOS </TD></TR>
		</TABLE>
		<BR>
		<TABLE id="tablaCuerpo" border="0" cellpadding="0" cellspacing="0" align="center" width="90%">
			<TR>
				...
				<TABLE cellpadding="0" cellspacing="0" border="0"  id="example" style="width:100%"  class="display">
					<THEAD>
						<TR style="width:100%">
							<TH class="tituloForm" width="10%">N&deg;</TH>
							<TH class="tituloForm" width="40%">Nombre del Proyecto</TH>
							<TH class="tituloForm" width="30%">Responsable</TH>
							<TH class="tituloForm" width="10">% Avance</TH>
							<TH class="tituloForm" width="10">Detalle</TH>
						</TR>
					</THEAD>
					<TBODY>
					<!-- ******************************************************************************************************************* -->
					...
					?>
					<TR class="gradeX">
						<TD class="textoCampo" align="center" style="width:5%"><a><?php echo $datproyec['id'][$a]; ?></a></TD>
						<TD class="textoCampo" style="width:45%"><a><?php echo $datproyec['np'][$a]; ?></a></TD>
						...
						<TD class="textoCampo" align="center">
						<?php $porcentaje=porcentaje_avance_proy($datproyec['id'][$a]);  

						 if($porcentaje['porcentaje_avance']==""){ echo "0%";}elseif ($porcentaje['porcentaje_avance']>100){ echo "100";}else{ echo $porcentaje['porcentaje_avance']."%";} 
						?>
						
						</TD>
						<TD class="textoCampo" align="center">
							<a class="link" href="control_y_seguimiento.php?id_proyecto=<?php echo $datproyec['id'][$a];?>">
