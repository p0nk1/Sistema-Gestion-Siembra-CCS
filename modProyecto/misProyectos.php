<?php
	...
	$datproyec=buscar_proyectos_por_responsable($_SESSION['adminProy']['id_usuario']);
...
<HTML>
	...
	<BODY>
		...
		<TABLE id="tablaTitulo" border="0" cellpadding="0" cellspacing="0" align="center" width="90%">
			<TR><TD class="tituloBackground">  MIS PROYECTOS </TD></TR>
		</TABLE>
		<BR>
				...
				<TABLE cellpadding="0" cellspacing="0" border="0"  id="example" style="width:100%"  class="display">
					<THEAD>
						<TR style="width:100%" class="titulo_tabla">
							...
							<TH class="tituloForm" width="70%">Nombre del Proyecto</TH>
							<TH class="tituloForm" width="15%">% Avance</TH>
							<TH class="tituloForm" width="10"> Ir </TH>
						</TR>
					</THEAD>
					<TBODY>
					<!-- ******************************************************************************************************************* -->
					...
					<TR class="gradeX">
						...
						<TD class="textoCampo" align="center">
							<a class="link" href="control_y_seguimiento.php?id_proyecto=<?=$datproyec['id'][$a];?>">
