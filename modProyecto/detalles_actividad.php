...
<td colspan="2" align="center" bgcolor="White"><br><input name="cerrar" value="Cerrar" style="width: 100px;" onclick="window.close();" type="button" class="botonPeq"></td>
	...
	$i=pg_num_rows($consult);
        ...
        <td style="width:2%;" class="texto_campo"><?php echo $row['fecha_avance'];?></td>
...
<?php if($row['porcentaje_avance_actividad']==""){ echo "0%";}elseif ($row['porcentaje_avance_actividad']>100){ echo "100";}else{ echo $row['porcentaje_avance_actividad']."%";} ?>
...
<script language='javascript'>initialize("sample<?php echo $y;?>");</script>-->		
		...
		if (($perfil == 3) and ($row['id_usuario_registra'] == $id_usuario_registra)) {
