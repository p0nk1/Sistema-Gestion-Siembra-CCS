...
<HTML>
	...
	<BODY>
		<TABLE id="tablaTitulo" border="0" cellpadding="0" cellspacing="0" align="center" width="90%">
			<TR><TD class="subtituloBackground">TAMA&Ntilde;O Y LOCALIZACI&Oacute;N DE LA F&Aacute;BRICA</TD></TR>
		</TABLE>
		<BR>
		<FORM action="" id="formRegSextoCap" name="formRegSextoCap" method="POST" onsubmit="">
		<TABLE id="tablaSextoCapitulo" border="0" cellpadding="2" cellspacing="2" align="center" width="80%">
		<TR>
			<TD>
			<div id="accordion">
				<div class="section">
					<h2>CAPACIDAD DE PRODUCCION DE LA PLANTA</h2>
				...
				<div class="section">
					...
					<TABLE border="0" cellpadding="0" cellspacing="1" align="center" width="95%" bgcolor="#D6D6D6">
						<TR><TD class="tituloTablas" align="center" colspan="4" bgcolor="#F2F2F2">CROQUIS DE LOCALIZACION DE LA EMPRESA</TD></TR>
						<TR>
							<TD>
							<div id="divPasoCero" class="acc_container">
								<div class="block">
									<iframe name="iframe" src="../foto/agregarCroqui.php" width="100%" height="350px" align="top" scrolling="no" style="border:0px solid green"></iframe>
								</div>
							</div>
							</TD>
						</TR>
