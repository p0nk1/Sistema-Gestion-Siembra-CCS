<?php
	...
	//ELIMINAR SOCIO
	if($eliminar){
		$resultado=eliminarSocioProyecto($idProyecto, $idSocio);
...
<HTML>
	...
	<BODY>
		<BR>
		<FORM action="" id="formElimSocios" name="formElimSocios" method="POST">
		<TABLE border="0" width="90%" cellpadding="0" cellspacing="0" align="center">
			<TR><TD class="tituloBackground"> ELIMINAR SOCIO </TD></TR>
			<TR><TD class="texto_rojo" height="100" align="center"> Esta seguro de eliminar a este socio? </TD></TR>
		</TABLE>
		<BR>
