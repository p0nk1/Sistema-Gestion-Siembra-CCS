...
<HTML>
	...
	<BODY>
		<TABLE id="tablaTitulo" border="0" cellpadding="0" cellspacing="0" align="center" width="90%">
			<TR><TD class="subtituloBackground">ESTUDIO TECNICO</TD></TR>
		</TABLE>
		<BR>
		<FORM action="" id="formRegSeptimoCap" name="formRegSeptimoCap" method="POST" onsubmit="">
		<TABLE id="tablaSeptimoCapitulo" border="0" cellpadding="2" cellspacing="2" align="center" width="80%">
		<TR>
			<TD>
			<div id="accordion">
				<div class="section">
					<h2>LISTA DE EQUIPOS Y MAQUINARIAS</h2>
				...
				<div class="section">
					<h2>DISTRIBUCION DE EQUIPOS Y MAQUINARIAS</h2>
					<div class="section-content">
						<TABLE border="0" cellpadding="0" cellspacing="0" align="center" width="95%">
							<TR bgcolor="White"><TD align="center"><BR><TEXTAREA name="" id="" rows="10" cols="153"><??></TEXTAREA><BR><BR></TD></TR>
						</TABLE>
				...
				<div class="section">
					<h2>FLUJO DE MATERIALES Y PERSONAS</h2>
					<div class="section-content">
						<TABLE border="0" cellpadding="0" cellspacing="0" align="center" width="95%">
							<TR bgcolor="White"><TD align="center"><BR><TEXTAREA name="" id="" rows="10" cols="153"><??></TEXTAREA><BR><BR></TD></TR>
						</TABLE>
