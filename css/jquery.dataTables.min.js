...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Mostrar _MENU_ Proyectos por pagina",sZeroRecords:"No hay registros coincidentes",sInfo:"Mostrando _START_ al _END_ de _TOTAL_ Registros",sInfoEmpty:"Mostrando 0 al 0 de 0 registros",sInfoFiltered:"(filtrado de _MAX_  registros)",sInfoPostFix:"",sSearch:"Buscar Proyecto:",sUrl:"",oPaginate:{sFirst:"Principio",sPrevious:"Anterior",sNext:"Siguiente",sLast:"Ultimo"}};
...
var sStdMenu='<select size="1" '+sName+'><option value="8">8</option><option value="20">20</option><option value="50">50</option><option value="100">100</option></select>';
