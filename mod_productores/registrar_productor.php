...
include_once ("../funciones/queryProductores.php");
...
if (isset($guardar_registro)) {
    ...
    //echo $cedula.' '.$nombres_usuario.' '.$email.' '.$serial.' '.$codigo.' '.$telefono_1.' '.$telefono_2.' '.$fecha_registro.' '.$direccion.' '.$id_usuario_registra;
    if ($mensaje == 'error') {
        ...
        registrar_productor(dar_formato($cedula), dar_formato($nombres_usuario), dar_formato($email), $serial,
         $codigo, dar_formato($telefono_1), dar_formato($telefono_2), dar_formato($fecha_registro),dar_formato($direccion),$id_usuario_registra);
    ...
    <body>
        ...
        <FORM method="POST" name="registrar_nuevo_usuario" action="" enctype="multipart/form-data">
            ...
            <TABLE border="0" width="70%" cellpadding="0" cellspacing="0" align="center">
                <TR>
                    <TD class="tituloForm">REGISTRO NUEVOS PRODUCTOR</TD>
                </TR>
                <TR><TD><HR></TD></TR>
            </TABLE>
...
<!--	<input name="p_nombre" id="p_nombre_a" type="hidden" value="<? //=$p_nombre   ?>">
        ...
        <INPUT type="hidden" name="fecha_nacimiento" id="fecha_nacimiento" value="<? //=$fecha_nacimiento   ?>">-->
                ...
                <!-- ******************************************* login y password  ************************************************-->
                <TD bgcolor="White" class="tituloTablas">&nbsp;Serial:<a class="campo_obligatorio" >&nbsp;*</a></TD>
                <TD bgcolor="White"><input name="serial" type="number" size="30" maxlength="15"></TD>
                </TR>
                <TR class="textoCampo">
                    <TD bgcolor="White"><span class="tituloTablas">&nbsp;Codigo:<a class="campo_obligatorio" >&nbsp;*</a></span></TD>
                    <TD bgcolor="White"><input name="codigo" type="number" size="30" maxlength="15"></TD>
                </TR>
                <TR class="textoCampo">
                    <TD bgcolor="White"><span class="tituloTablas">&nbsp;Dirección:<a class="campo_obligatorio" >&nbsp;*</a></span></TD>
                    <TD bgcolor="White"><input name="direccion" type="text" size="30" maxlength="200"></TD>
                </TR>
